            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        sess = crypto_1.default.createHmac('sha256', config_json_1.default.config_server.key_code).update(id + "_" + (0, DateStr_1.dateTimeToSQL)(date) + "_" + db.rows[0].selectiduser).digest('hex');
